...
<div class="section">
  <div class="section-title">Professional Summary</div>
  <p>Customer support specialist with 4+ years in high-volume, regulated environments. Own cases end to end — payments, account access, KYC, and compliance issues — and support high-value customers where trust and retention matter. Daily Intercom, Zendesk, Jira, and Confluence. Fluent in Finnish and English.</p>
</div>
...
<div class="section">
  ...
  <div class="job">
    ...
    <div class="job-meta">August 2023 – Present</div>
    <ul>
      <li>Own enquiries end to end — payments, bonuses, account access, verification, withdrawals — and stay the customer’s main contact until closed.</li>
      <li>Support high-value / VIP players; work with KYC, compliance, risk, and payments while keeping ownership of the case.</li>
      <li>De-escalate tense situations and deliver difficult news clearly (limits, verification, restrictions).</li>
      <li>Spot at-risk friction early; protect retention with high-touch service and clear communication.</li>
      <li>Flag recurring issues and product bugs in Jira; document fixes in Confluence for the team.</li>
      <li>Handle high volume across live and written channels without dropping quality.</li>
    </ul>
  </div>
  <div class="job">
    <div class="job-title">Game Presenter / Help Desk — Evolution, Malta</div>
